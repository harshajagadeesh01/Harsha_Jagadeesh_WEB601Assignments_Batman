...
@Component({
    ...
    imports: [CommonModule, ContentTypeFilterPipe, FormsModule, HoverOverDirective, ModifyContentComponent, MatCardModule, MatButtonModule, MatInputModule,],
})
export class ContentListComponent implements OnInit {
  ...
  constructor(private batmanService: BatmanServiceService, private snackBar: MatSnackBar) {
  ...
  imBatman() {
    this.snackBar.open('I am Batman!', 'Dismiss', { duration: 2000 });
  }
